...
def response = WS.sendRequest(findTestObject('Object Repository/login/POST_Login_Unsuccessful_because_missing_email'))
...
//marking: PASSED
KeywordUtil.markPassed("Register Gagal Karena missing email")