...
def response = WS.sendRequest(findTestObject('Object Repository/register/POST_Register_Unsuccessful_because_missing_email'))
...
//marking: PASSED
KeywordUtil.markPassed("Register Gagal Karena tidak ada email")