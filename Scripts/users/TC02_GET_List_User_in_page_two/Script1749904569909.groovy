...
def response = WS.sendRequest(findTestObject('Object Repository/users/GET_List_User_PageTwo'))
...
//verifikasi Body Response dan benar berada di page 2
...
//marking: PASSED
KeywordUtil.markPassed("User berhasil mengakses halaman list user page two")